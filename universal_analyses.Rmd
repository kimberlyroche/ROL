...
Lastly, rank all interactions by their "universality," i.e. the degree to which they have a large median correlation across.

```{r}
get_universal_interactions(tax_level=tax_level, show_plot=TRUE)
```
